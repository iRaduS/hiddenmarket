        ...
        <div class="col-md-4">
            ...
            <p class="text-muted">
                Number of sales: <span
                        class="badge badge-light">{{ $product -> user -> vendor -> salesCount('delivered') }}</span>
                <br>
                Number of received feedback: <span class="badge badge-light">{{ $product -> user -> vendor -> countFeedback() }}</span>
            </p>
