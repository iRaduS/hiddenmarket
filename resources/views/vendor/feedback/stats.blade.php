<div class="row mt-2">
    <div class="col-md-6">
        ...
        <table class="table">
            ...
            <tr>
                <td>
                    <span class="fa fa-plus-circle text-success"></span> Positive
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="fa fa-stop-circle text-secondary"></span>  Neutral
                </td>
                <td>
            ...
            <tr>
                <td>
                    <span class="fa fa-minus-circle text-danger"></span> Negative
                </td>
                <td>
