    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            ...
            @if(auth() -> user() -> conversations -> isNotEmpty())
                ...
                <a href="{{ route("profile.messages.conversations.list") }}"  class="btn mt-2 w-100 btn-indigo ">
                    <i class="fa fa-list"></i>
                    All Conversations
                </a>

                <a href="{{ route("profile.messages") }}" class="btn mt-2 w-100 btn-dark ">
        ...
        <div class="col-md-8">
            ...
            @else
                ...
                <form action="{{ route('profile.messages.message.new', $conversation) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-dark ml-auto mt-2 d-block">Send message</button>
                    {{ csrf_field() }}
                </form>
                @endif
