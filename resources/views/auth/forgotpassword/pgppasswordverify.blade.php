            ...
            <div class="mt-3">
                ...
                <form method="POST" action="{{ route('auth.resetpgp') }}">
                    ...
                    <div class="form-group" style="display:flex">
                        ...
                        <input type="text" class="form-control col-md-12" name="validation_string" id="validation_string" placeholder="Validation string"/>
                    ...
                    <div class="form-group text-center">
                        <div class="row">
                            <div class="col-xs-12 col-md-12 offset-md-12">
                                <button type="submit" class="btn btn-outline-dark btn-block" style="margin-top: 15px;">Reset password</button>
                            </div>
                        </div>
                    </div>
                </form>
