        ...
        <tbody>
            @foreach($myProducts as $product)
                <tr>
                    ...
                    <td><span class="badge badge-light">{{ $product -> isDigital() ? 'Digital' : 'Physical' }}</span></td>
                    <td class="text-right">
                        <a href="{{ route('profile.vendor.product.clone.show', $product ) }}" class="btn btn-sm btn-indigo">
                            Clone
                        </a>
                        <a href="{{ route('profile.vendor.product.edit', $product -> id) }}" class="btn btn-sm btn-dark">
