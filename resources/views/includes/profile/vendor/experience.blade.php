        ...
        @if($vendor->experience < 0)
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <p class="text-danger border border-danger rounded p-1 mt-2 text-center"><span class="fa fa-exclamation-circle"></span> Negative experience, trade with caution !</p>
                </div>
