    ...
    <div class="form-row">
       ...
       <div class="col-md-4 my-2">
        ...
        <div class="col-md-4 my-2 text-right">
            <button class="btn btn-outline-success" type="submit"><i class="fa fa-plus mr-2"></i> Add shipping</button>
        </div>
    </div>
</form>
    ...
    <div class="form-row justify-content-center">
        <div class="col-md-3 text-center">
            ...
            @if(request() -> is('profile/vendor/product/edit/*'))
                <button class="btn btn-outline-success" type="submit"><i class="fa fa-save mr-2"></i> Save</button>
                <a href="{{ route('profile.vendor.product.edit', [$basicProduct, 'images']) }}" class="btn btn-outline-dark"><i class="fa fa-chevron-down mr-2"></i> Next</a>
            @elseif(request() -> is('admin/product/*'))
                <button class="btn btn-outline-success" type="submit"><i class="fa fa-save mr-2"></i> Save</button>
                <a href="{{ route('admin.product.edit', [$basicProduct, 'images']) }}" class="btn btn-outline-dark"><i class="fa fa-chevron-down mr-2"></i> Next</a>
            @else
                <button class="btn btn-outline-dark" type="submit"><i class="fa fa-chevron-down mr-2"></i>  Next</button>
            @endif
        </div>
    </div>
</form>
