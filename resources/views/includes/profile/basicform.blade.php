            ...
            <div class="form-group col-md-3 text-center">
                @if(request() -> is('profile/vendor/product/edit/*'))
                    ...
                    <a href="{{ route('profile.vendor.product.edit', [$basicProduct, 'offers']) }}"
                       class="btn btn-outline-dark"><i class="fa fa-chevron-down mr-2"></i> Next</a>
                @elseif(request() -> is('admin/product/*'))
                    <button class="btn btn-outline-success" type="submit"><i class="fa fa-save mr-2"></i> Save</button>
                    <a href="{{ route('admin.product.edit', [$basicProduct, 'offers']) }}"
                       class="btn btn-outline-dark"><i class="fa fa-chevron-down mr-2"></i> Next</a>
                @else
                    <button class="btn btn-outline-dark" type="submit"><i class="fa fa-chevron-down mr-2"></i> Next
                    </button>
                @endif
            </div>
        </div>
