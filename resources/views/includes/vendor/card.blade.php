    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <p> <span class="btn @if($vendor->vendor->experience >= 0) btn-dark @else btn-danger @endif active" style="cursor:default">Level {{$vendor->vendor->getLevel()}}</span>
            ...
            <div class="col-sm-4 text-right">
                <p>
                    <a href="{{ route('profile.messages').'?otherParty='.$vendor->username}}" class="btn btn-outline-secondary"><span class="fa fa-envelope"></span> Send message</a></p>
            </div>
        </div>
        <div class="row">
            <div class="col">
