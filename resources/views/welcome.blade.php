...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-12" style="margin-top:2.3em">
            ...
            @include('includes.cryptocurrencies')
        </div>
        <div class="col-lg-9 col-sm-12 mt-3 ">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4">
                    <h4><i class="fa fa-money text-indigo"></i> No deposit</h4>
                    <p>
                ...
                <div class="col-md-4">
                    <h4><i class="fa fa-shield text-indigo"></i> Escrow</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquid dolorem hic nisi
                        ratione repellendus suscipit totam vitae!
                    </p>
                ...
                <div class="col-md-4">
                    <h4><i class="fa fa-bitcoin text-indigo"></i> Multiple-Coins</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquid dolorem hic nisi
                        ratione repellendus suscipit totam vitae!
                    </p>
                    ...
                    @foreach(\App\Vendor::topVendors() as $vendor)
                        <table class="table table-borderless table-hover">
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="btn btn-sm @if($vendor->vendor->experience >= 0) btn-dark @else btn-danger @endif active"
