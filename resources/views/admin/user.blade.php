            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    @foreach($user -> vendorPurchases as $depositAddress)
                        <tr>
                            <td>
                                <span class="badge badge-light">{{ strtoupper($depositAddress -> coin) }}</span>
                            </td>
                            <td>
                                <input type="text" readonly class="form-control" value="{{ $depositAddress -> address }}"/>
                            </td>
                            <td class="text-right">
                                <span class="badge badge-success">{{ $depositAddress -> amount }}</span>
                            </td>
                            <td class="text-right">
                                @if($depositAddress -> isEnough())
                                    <span class="badge badge-success">Enough funds</span>
                                @endif
                                <span class="badge badge-light">{{ $depositAddress -> balance }}</span>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
