            ...
            @else
                @foreach($purchases as $purchase)
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-light">{{ $purchase->buyer->username }}</span>
                        </td>
                        <td>
                            <a href="{{route('admin.users.view',['user'=>$purchase->vendor->user->id])}}" class="badge badge-success">{{$purchase->vendor->user->username}}</a>
                        </td>
                        <td>
