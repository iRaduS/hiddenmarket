                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group" style="margin-top:2em">
                            <button type="submit" class="btn btn-dark">Apply query</button>
                        </div>
                    </div>
            ...
            @else
                @foreach($products as $product)
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-light">{{$product->type}}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.product.edit', $product -> id) }}" class="btn btn-outline-indigo">
